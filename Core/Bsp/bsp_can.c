...
extern struct Super_cap_t super_cap;
...
HAL_StatusTypeDef CanFilterInit(CAN_HandleTypeDef* hcan)
{
	...
	sFilterConfig.FilterMaskIdHigh = 0x206 << 5;	//拨弹轮
	sFilterConfig.FilterMaskIdLow = 0x211 << 5;	//超级电容
...
//		super_cap_encoder(&super_cap,RecvData);
		//break;
	default:;
	}
}
